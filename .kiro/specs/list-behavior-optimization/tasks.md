...
- [-] 1. 创建 ListBehaviorHandler 组件
  - [-] 1.1 创建 ListBehaviorHandler.swift 文件
  ...
  - [ ] 1.2 编写 ListBehaviorHandler 光标位置限制单元测试
...
- [ ] 2. 实现光标位置限制
  - [ ] 2.1 扩展 NativeTextView 重写光标移动方法
...
- [ ] 3. Checkpoint - 确保光标限制功能正常
  - 运行所有单元测试和属性测试
  - 验证光标不能移动到列表标记左侧
  - 如有问题，询问用户

- [ ] 4. 实现回车键文本分割
  - [ ] 4.1 在 ListBehaviorHandler 中实现回车键处理
  ...
  - [ ] 4.2 更新 NativeTextView 的 keyDown 方法
...
- [ ] 7. Checkpoint - 确保回车键功能正常
  - 运行所有单元测试和属性测试
  - 验证文本分割、格式继承、空列表取消功能
  - 如有问题，询问用户

- [ ] 8. 实现删除键行合并
  - [ ] 8.1 在 ListBehaviorHandler 中实现删除键处理
  ...
  - [ ] 8.2 更新 NativeTextView 的 keyDown 方法
...
- [ ] 10. 实现有序列表编号更新
  - [ ] 10.1 在 ListBehaviorHandler 中实现编号更新
...
- [ ] 12. 实现勾选框状态切换
  - [ ] 12.1 在 ListBehaviorHandler 中实现勾选框处理
  ...
  - [ ] 12.2 扩展 NativeTextView 处理勾选框点击
