...
### 2. Preview 代码更新 (低优先级)
以下文件中的 Preview 使用 `NotesViewModel()`:
...
**建议**: 
- ✅ 已创建 `PreviewHelper` 提供测试用的 ViewModel
- 可以逐步更新 Preview 代码使用 `PreviewHelper.shared.createPreviewViewModel()`
- 不影响应用实际功能,可以按需更新
