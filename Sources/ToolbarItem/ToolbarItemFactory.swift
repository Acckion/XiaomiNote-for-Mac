...
//
    ...
    public class ToolbarItemFactory {
        ...
        private func createSearchToolbarItem(target _: AnyObject?) -> NSToolbarItem {
        ...
        private func createSidebarTrackingSeparatorToolbarItem(target _: AnyObject?) -> NSToolbarItem? {
            // 侧边栏跟踪分隔符 - 连接到分割视图的第一个分隔符
            // 注意：这个方法需要访问窗口控制器，这里返回nil，由调用者处理
            nil
        }

        private func createTimelineTrackingSeparatorToolbarItem(target _: AnyObject?) -> NSToolbarItem? {
