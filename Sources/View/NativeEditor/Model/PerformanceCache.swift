...
struct CacheStatistics {
    /// 字体缓存命中次数
    var fontCacheHits: Int = 0
    
    /// 字体缓存未命中次数
    var fontCacheMisses: Int = 0
    
    /// 段落样式缓存命中次数
    var paragraphStyleCacheHits: Int = 0
    
    /// 段落样式缓存未命中次数
    var paragraphStyleCacheMisses: Int = 0
    
    /// 颜色缓存命中次数
    var colorCacheHits: Int = 0
    
    /// 颜色缓存未命中次数
    var colorCacheMisses: Int = 0
...
extension CacheStatistics: CustomStringConvertible {
    var description: String {
        ...
        - 段落样式缓存: \(paragraphStyleCacheHits) 命中 / \(paragraphStyleCacheMisses) 未命中 (命中率: \(String(format: "%.2f%%", paragraphStyleCacheHitRate * 100)))
