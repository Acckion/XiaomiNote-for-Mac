...
public protocol NoteStorageProtocol: Sendable {
    ...
    /// - Returns: 笔记数组
    func fetchNotes(in folderId: String) async throws -> [Note]
    ...
    /// 获取收藏的笔记
    /// - Returns: 收藏的笔记数组
    func fetchStarredNotes() async throws -> [Note]
    ...
    func performBatchUpdate(_ block: @Sendable () throws -> Void) async throws
    ...
    /// - Parameter folderId: 文件夹ID
    /// - Returns: 笔记数量
    func getNoteCount(in folderId: String) async throws -> Int
