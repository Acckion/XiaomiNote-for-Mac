...
/// 统一日志服务
final class LogService: Sendable {
    ...
    func debug(_ module: LogModule, _ message: String) {
        logger(for: module).debug("[\(module.rawValue)] \(message)")
    }

    func info(_ module: LogModule, _ message: String) {
        logger(for: module).info("[\(module.rawValue)] \(message)")
    }

    func warning(_ module: LogModule, _ message: String) {
        logger(for: module).warning("[\(module.rawValue)] \(message)")
    }

    func error(_ module: LogModule, _ message: String) {
    ...
    func debugSensitive(_ module: LogModule, _ message: String, sensitiveValue: String) {
        #if DEBUG
    ...
    func infoSensitive(_ module: LogModule, _ message: String, sensitiveValue: String) {
        #if DEBUG
