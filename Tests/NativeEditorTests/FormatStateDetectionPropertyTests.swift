...
final class FormatStateDetectionPropertyTests: XCTestCase {
    ...
    /// 4. 更新格式状态
    /// 5. 验证加粗格式被正确检测
    func testProperty3_BoldFormatStateDetectionAccuracy() {
        let iterations = 100
    ...
    /// **验证需求**: 2.2
    func testProperty3_ItalicFormatStateDetectionAccuracy() {
        let iterations = 100
    ...
    /// **验证需求**: 2.3
    func testProperty3_UnderlineFormatStateDetectionAccuracy() {
        let iterations = 100
    ...
    /// **验证需求**: 2.4
    func testProperty3_StrikethroughFormatStateDetectionAccuracy() {
        let iterations = 100
    ...
    /// **验证需求**: 2.5
    func testProperty3_HighlightFormatStateDetectionAccuracy() {
        let iterations = 100
    ...
    /// **验证需求**: 2.1, 2.2, 2.3, 2.4, 2.5
    func testProperty3_MixedInlineFormatStateDetectionAccuracy() {
        let iterations = 50
        ...
        for iteration in 1 ... iterations {
            ...
            let formatNames = appliedFormats.map(\.displayName).joined(separator: ", ")
    ...
    /// 4. 更新格式状态
    /// 5. 验证标题格式被正确检测
    func testProperty4_HeadingFormatStateDetectionAccuracy() throws {
        let iterations = 100
    ...
    /// **验证需求**: 2.7, 2.8
    func testProperty4_AlignmentFormatStateDetectionAccuracy() throws {
        let iterations = 100
    ...
    /// **验证需求**: 2.10
    func testProperty4_QuoteFormatStateDetectionAccuracy() {
        let iterations = 100
