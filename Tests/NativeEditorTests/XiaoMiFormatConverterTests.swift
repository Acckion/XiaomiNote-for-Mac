...
final class XiaoMiFormatConverterTests: XCTestCase {
    ...
    func testComplexRoundTripConversion() {
        let complexXML = """
    ...
    func testConversionPerformance() {
        ...
        measure {
            do {
                _ = try converter.xmlToAttributedString(largeXML)
            } catch {
    ...
    func testConsecutiveOrderedListInputNumber() throws {
        ...
        XCTAssertTrue(
            xml.contains("<order indent=\"1\" inputNumber=\"0\" />"),
    ...
    func testNonConsecutiveOrderedListInputNumber() throws {
        ...
        XCTAssertTrue(
            xml.contains("<order indent=\"1\" inputNumber=\"4\" />"),
