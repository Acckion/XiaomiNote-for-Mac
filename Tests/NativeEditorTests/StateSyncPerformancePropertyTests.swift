...
final class StateSyncPerformancePropertyTests: XCTestCase {
    ...
    /// 性能阈值（毫秒）
    let performanceThresholdMs = 100.0
    ...
    /// 3. 测量状态同步时间
    /// 4. 验证同步时间在100ms内
    func testProperty6_CursorMoveStateSyncPerformance() {
        let iterations = 100
    ...
    /// **验证需求**: 3.2
    func testProperty6_SelectionChangeStateSyncPerformance() {
        let iterations = 100
    ...
    /// **验证需求**: 3.2
    func testProperty6_MixedFormatStateSyncPerformance() {
        let iterations = 100
    ...
    /// **验证需求**: 3.2
    func testProperty6_LargeTextStateSyncPerformance() {
    ...
    /// **验证需求**: 3.2
    func testProperty6_ContinuousCursorMoveStateSyncPerformance() {
        let iterations = 50
