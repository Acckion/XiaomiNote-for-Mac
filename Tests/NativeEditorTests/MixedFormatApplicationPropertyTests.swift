...
final class MixedFormatApplicationPropertyTests: XCTestCase {
    ...
    /// 4. 应用格式到整个选中范围
    /// 5. 验证整个选中范围都有格式
    func testProperty15_MixedFormatApplicationToEntireRange() {
        let iterations = 100
    ...
    /// **验证需求**: 6.3
    func testProperty15_MixedFormatRemovalFromEntireRange() {
        let iterations = 100
    ...
    /// **验证需求**: 6.3
    func testProperty15_ToggleStrategyMixedFormatApplication() {
        let iterations = 100
    ...
    /// **验证需求**: 6.3
    func testProperty15_BoldMixedFormatApplication() {
        let iterations = 100
    ...
    /// **验证需求**: 6.3
    func testProperty15_ItalicMixedFormatApplication() {
        let iterations = 100
