...
public final class MockAudioService: AudioServiceProtocol, @unchecked Sendable {
    ...
    public var mockIsRecording = false
    ...
    public func play(url _: String) async throws {
        playCallCount += 1
    ...
    public func uploadAudio(_: Data) async throws -> String {
    ...
    public func downloadAudio(from _: String) async throws -> Data {
